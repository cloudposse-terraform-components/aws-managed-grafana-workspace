...
| <a name="module_managed_grafana"></a> [managed\_grafana](#module\_managed\_grafana) | cloudposse/managed-grafana/aws | 0.5.0 |
...
|------|-------------|------|---------|:--------:|
| <a name="input_additional_allowed_role_arns"></a> [additional\_allowed\_role\_arns](#input\_additional\_allowed\_role\_arns) | A list of IAM role ARNs that the Grafana workspace role should be allowed to assume. Use this for cross-account access to services like CloudWatch | `list(string)` | `[]` | no |
